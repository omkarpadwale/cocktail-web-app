  ...
  const AllIngredients = () => {
    ...
    if (ResponseRandomDrink.strIngredient4) {
      ingridient +=
        ...
        " : " +
        ResponseRandomDrink.strMeasure4?ResponseRandomDrink.strMeasure4:"";
    }
    return ingridient;
  };
  ...
  return (
    <div>
      <header className="App-header">
        <Card sx={{ maxWidth: 650 }} style={{ padding: "50px" }}>
          <CardActionArea>
            <CardContent>
              <Typography variant="h3" component="h3">
                {ResponseRandomDrink.strAlcoholic}
              </Typography>            
            </CardContent>
            <CardMedia
              component="img"
            ...
            <CardContent>
              ...
              <b>Category :</b> {ResponseRandomDrink.strCategory}
              </Typography>
              <Typography variant="body2" color="text.primary">
                <b>Ingridient List :</b> {AllIngredients()}
              </Typography>
              <Typography variant="body2" color="text.primary">
                <b>Utensil :</b> {ResponseRandomDrink.strGlass}
              </Typography>
